  ...
  return (
    <div className="p-6 space-y-6 max-w-2xl">
      <div>
        ...
        <p className="text-sm text-muted-foreground">AI providers, model defaults, and @lu commands</p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-1 text-xs">
          {[
            ["Database",      "~/.command-center/cc.db"],
            ["Daily logs",    "~/.command-center/daily/"],
            ["Knowledge docs","~/.command-center/docs/"],
            ["Todos",         "~/.command-center/todos/"],
            ["AGENTS.md",     "~/.command-center/agents-md/"],
          ].map(([label, path]) => (
